    ...
    <div className="">
      <div className="  h-screen w-full rounded-md flex items-center justify-center md:items-center md:justify-center antialiased bg-grid-white/[1] relative overflow-hidden ">
        ...
        <div className="relative lg:flex lg:flex-row-reverse md:flex md:flex-row-reverse  lg:">
          ...
          <div className=" space-y-2 md:max-w-2xl lg:max-w- flex items-center justify-center flex-col lg:flex lg:items-start lg:p-6 ">
            <motion.div
              initial={{ opacity: 0, y: 50 }}
              animate={{ opacity: 1, y: 0 }}
...
Yusuff Abdulkareem Abdullateef"
            ...
            >
              <a
                href="https://docs.google.com/document/d/1R28inVdzQyfGnjg3sfDhD4QKBDZUuISHB9zW_m6foUM/edit?usp=sharing"
                target="_blank"
              >
                <MagicButton title="view my Resume" position="right" />
              </a>
              <div className="mt-2">
                <SocialMedia />
              </div>
